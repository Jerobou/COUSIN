...
<script src="./js/clustering_analysis.js"></script>
...
<div class="container-fluid">
					...
					<div class="form-type-of-var">
							<label for="type-of-var">variables analyzed </label>
							<select type="text" class="form-control" id="type_of_var" name="type_of_var" required>
								<option value="variables">COUSIN results ("all_variables")</option>
								<option value="codons">Vector of codons frequencies ("codons")</option>
								<option value="GC_content">GC content variables ("GC_content")</option>
								<option value="ATGC_content">A, T, G and C content variables ("ATGC_content")</option>
								<option value="all_indexes">All indexes contained in the tool ("all_indexes")</option>
								<option value="basic_analysis">COUSIN, CAI and GC content ("basic_analysis")</option>
							</select>
						</div>
					<div class="form-number-cluster">
						<label for="number-cluster">Number of clusters (0 = x-means)</label>
						<textarea class="form-control" rows="1" id="number_cluster" name="number_cluster">0</textarea>
					</div>
					<div class="form-pattern-clustering">
							<label for="pattern_data_clustering">Or enter pattern data... </label>
							<textarea class="form-control" rows="3" id="pattern_data_clustering" name="pattern_data_clustering"></textarea>
							<input type="file"  id="pattern_file_clustering" name="pattern_file_clustering">
						</div>
