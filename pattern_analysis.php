<?php
	include('header.php');
?>
<script src="./js/pattern_analysis.js"></script>
    ...
    <div>
      ...
      <div id="options" class="panel panel-default">
        <center>
		<form id="pattern_analysis-form">
    	<div id = "option_1">
    	<div class="container-fluid">
							<div class="form-fasta">
								<label for="fasta_sequences">FASTA sequences * </label>
    					...
    					<div class="form-cu-table">
    						<label for="cu_table">Codon Usage Table (<a href="http://www.kazusa.or.jp/codon/cgi-bin/showcodon.cgi?species=9606" target="_blank">kazusa </a> format) * </label><textarea class="form-control" rows="3" id="cu_table" name="cu_table"></textarea></label>
  ...
  <div class="container-fluid">
          ...
          <div class="form-pattern">
            <label for="pattern_data">Pattern data </label>
            <textarea class="form-control" rows="3" id="pattern_data" name="pattern_data"></textarea>
