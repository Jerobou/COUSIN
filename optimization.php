	...
	<div>
		...
		<div class="container-fluid">
						...
						<div class="form-cu-table">
							<label for="cu_table">Codon Usage Table (<a href="http://www.kazusa.or.jp/codon/cgi-bin/showcodon.cgi?species=9606" target="_blank">kazusa </a> format) * </label>
...
<div class="container-fluid">
				...
				<div class="form-sequences-format">
					<label for="sequences_format">Genetic Code * </label>
					<select type="text" class="form-control" id="sequences_format" name="sequences_format" required>
						<option value="DNA">DNA</option>
						<option value="AA">AA (amino acids)</option>
					</select>
				</div>
				<div class="form-optimization-type">
						<label for="optimization_type">Optimization type * </label>
						<select type="text" class="form-control" id="optimization_type" name="optimization_type" required>
							<option value="0">1 - Random </option>
							<option value="1">2 - Random Guided</option>
							<option value="2">3 - Random with max GC content</option>
							<option value="3">4 - Random Guided with max GC content</option>
							<option value="4">5 - Random with max AT content</option>
							<option value="5">6 - Random Guided with max AT content</option>
							<option value="6">7 - One amino acid - One codon (Codons with highest frequencies)</option>
							<option value="7">8 - One amino acid - One codon (Codons with lowest frequencies)</option>
						</select>
					</div>
					<div class="form-number-optimization">
						<label for="number_optimization">Number of optimizations</label>
						<textarea class="form-control" rows="1" id="number_optimizations" name="number_optimizations" required>10</textarea>
					</div>

					<div class="form-reverse-frequencies">
						<label for="reverse_frequencies"> Reverse frequencies</label>
						<select type="text" class="form-control" id="reverse_frequencies" name="reverse_frequencies" required>
							<option value="0">0 - Don't </option>
