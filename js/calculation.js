...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (document.getElementById('calculation_form') != null) {
		// identification du formulaire (récupération sous forme d'une variable)
		var form = document.getElementById('calculation_form');
		...
		form.addEventListener("submit", function(event) {
			...
			if (accept_analysis == true) {
				...
				request.open("POST", "./php/calculation_step.php", true); // ouverture du code ajout de données php
