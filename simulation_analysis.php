...
<script src="./js/simulation_analysis.js"></script>
	...
	<div>
		...
		<div class="container-fluid">
						<div class="form-fasta">
							...
							<input type="file" id="fasta_file" name="fasta_file"> </input>
						</div>
...
<div class="container-fluid">
					...
					<div class="form-number-simulation">
						<label for="number-simulations">Number of simulations</label>
						<textarea class="form-control" rows="1" id="number_simulation" name="number_simulation" required>500</textarea>
					</div>
