...
$number_simulation = intval($_REQUEST['number_simulation']);
...
$exec_code = "python3 ./cousin/cousin.py simulation_analysis -s ".$fasta_file." -c ".$cu_file." -g ".$genetic_code." -S ".$simulation_routine." -X ".$specific_COUSIN." -J ".$vector_analysis." -b ".$optimal_codons_file." -n ".$number_simulation." -o ./outputs/".$folder_output_name." 2>&1";
