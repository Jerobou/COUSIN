...
$exec_code = "python3 ./cousin/cousin.py calculation -s ".$fasta_file." -c ".$cu_file." -g ".$genetic_code." -S ".$simulation_routine." -X ".$specific_COUSIN." -J ".$vector_analysis." -b ".$optimal_codons_file." -o ./outputs/".$folder_output_name." 2>&1";
