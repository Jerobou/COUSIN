...
def compare_data(genet_code_type, output_dir) :
	...
	if compare_type == "cvc" :
		...
		cousin_functions.write_file(output_dir + "/data_comparison/comparison_results.tsv", results_data_comparison, results_data_comparison_list)
		...
		for header_seq in liste_sequences_1 :
			for header_seq_2 in liste_sequences_2 :
				...
				if not os.path.isdir(output_dir + "/data_comparison") :
					os.system('mkdir ./' + output_dir + "/data_comparison")
				cousin_functions.write_file(output_dir + "/data_comparison/comparison_results_" + header_seq[:50] + "_vs_" + header_seq_2[:50] + ".tsv", results_data_comparison, results_data_comparison_list)
		...
		for header_seq in cousin_functions.content_seq :
			...
			if not os.path.isdir(output_dir + "/data_comparison") :
				os.system('mkdir ./' + output_dir + "/data_comparison")
			cousin_functions.write_file(output_dir + "/data_comparison/comparison_results_cu_table_vs_" + header_seq[:50] + ".tsv", results_data_comparison, results_data_comparison_list)
...
def prepare_data(input_file_seq, genet_code_type, optimal_codons_file, output_dir) :
	...
	if input_file_seq_type == "DNA" :
		...
		cousin_functions.write_file(output_dir + "/results/results.tsv", results, results_list)
...
def do_optimization(output_dir) :
	...
	cousin_functions.write_file_optimization(output_dir + "/optimization/optimization_results.tsv", results_optimization, results_optimization_list)
...
def do_simulation_analysis(output_dir) :
	...
	cousin_functions.write_file_simulation(output_dir + "/simulation_results/simulation_results.tsv", results_simulation, results_simulation_list)
...
def do_clustering_analysis(output_dir) :
	...
	cousin_functions.write_file_clustering(output_dir + "/clustering/clustering_results.tsv", results_clustering, results_clustering_list)
