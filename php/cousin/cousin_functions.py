...
def create_data_vector(cu_dict, di_cu_dict, RSCU_data, header, output_dir) :
	...
	if os.path.isfile(output_dir + "/vector_data/vector_occurences.tsv") :

		vector_file = open(output_dir + "/vector_data/vector_occurences.tsv", "a")
		...
		vector_file = open(output_dir + "/vector_data/vector_occurences.tsv", "w")
	...
	if os.path.isfile(output_dir + "/vector_data/vector_frequencies.tsv") :

		vector_file = open(output_dir + "/vector_data/vector_frequencies.tsv", "a")
		vector_file.write(str(header) + "\t")
		...
		vector_file = open(output_dir + "/vector_data/vector_frequencies.tsv", "w")
		vector_file.write("Header" + "\t" + "AUG" + "\t" + "UGG" + "\t" + "AAU" + "\t" + "AAC" + "\t" + "GAU" + "\t" + "GAC" + "\t" + "UGU" + "\t" + "UGC" + "\t" + "CAA" + "\t" + "CAG" + "\t" + "GAA" + "\t" + "GAG" + "\t" + "CAU" + "\t" + "CAC" + "\t" + "AAA" + "\t" + "AAG" + "\t" + "UUU" + "\t" + "UUC" + "\t" + "UAU" + "\t" + "UAC" + "\t" + "AUU" + "\t" + "AUC" + "\t" + "AUA" + "\t" + "GCU" + "\t" + "GCC" + "\t" + "GCA" + "\t" + "GCG" + "\t" + "GGU" + "\t" + "GGC" + "\t" + "GGA" + "\t" + "GGG" + "\t" + "CCU" + "\t" + "CCC" + "\t" + "CCA" + "\t" + "CCG" + "\t" + "ACU" + "\t" + "ACC" + "\t" + "ACA" + "\t" + "ACG" + "\t" + "GUU" + "\t" + "GUC" + "\t" + "GUA" + "\t" + "GUG" + "\t" + "CGU" + "\t" + "CGC" + "\t" + "CGA" + "\t" + "CGG" + "\t" + "AGA" + "\t" + "AGG" + "\t" + "UUA" + "\t" + "UUG" + "\t" + "CUU" + "\t" + "CUC" + "\t" + "CUA" + "\t" + "CUG" + "\t" + "UCU" + "\t" + "UCC" + "\t" + "UCA" + "\t" + "UCG" + "\t" + "AGU" + "\t" + "AGC" + "\t" + "UAG" + "\t" + "UAA" + "\t" + "UGA" + "\n")
		vector_file.write(str(header) + "\t")
	...
	if os.path.isfile(output_dir + "/vector_data/di_vector_occurences.tsv") :

		vector_file = open(output_dir + "/vector_data/di_vector_occurences.tsv", "a")
		vector_file.write(str(header) + "\t")
		...
		vector_file = open(output_dir + "/vector_data/di_vector_occurences.tsv", "w")
	...
	if os.path.isfile(output_dir + "/vector_data/di_vector_frequencies.tsv") :

		vector_file = open(output_dir + "/vector_data/di_vector_frequencies.tsv", "a")
		vector_file.write(str(header) + "\t")
		...
		vector_file = open(output_dir + "/vector_data/di_vector_frequencies.tsv", "w")
		vector_file.write("Header" + "\t" + "\t".join(total_list_dicodon) + "\n")
		vector_file.write(str(header) + "\t")
	...
	if os.path.isfile(output_dir + "/vector_data/vector_RSCU.tsv") :

		vector_file = open(output_dir + "/vector_data/vector_RSCU.tsv", "a")
		vector_file.write(str(header) + "\t")
		...
		vector_file = open(output_dir + "/vector_data/vector_RSCU.tsv", "w")
		vector_file.write("Header" + "\t" + "AUG" + "\t" + "UGG" + "\t" + "AAU" + "\t" + "AAC" + "\t" + "GAU" + "\t" + "GAC" + "\t" + "UGU" + "\t" + "UGC" + "\t" + "CAA" + "\t" + "CAG" + "\t" + "GAA" + "\t" + "GAG" + "\t" + "CAU" + "\t" + "CAC" + "\t" + "AAA" + "\t" + "AAG" + "\t" + "UUU" + "\t" + "UUC" + "\t" + "UAU" + "\t" + "UAC" + "\t" + "AUU" + "\t" + "AUC" + "\t" + "AUA" + "\t" + "GCU" + "\t" + "GCC" + "\t" + "GCA" + "\t" + "GCG" + "\t" + "GGU" + "\t" + "GGC" + "\t" + "GGA" + "\t" + "GGG" + "\t" + "CCU" + "\t" + "CCC" + "\t" + "CCA" + "\t" + "CCG" + "\t" + "ACU" + "\t" + "ACC" + "\t" + "ACA" + "\t" + "ACG" + "\t" + "GUU" + "\t" + "GUC" + "\t" + "GUA" + "\t" + "GUG" + "\t" + "CGU" + "\t" + "CGC" + "\t" + "CGA" + "\t" + "CGG" + "\t" + "AGA" + "\t" + "AGG" + "\t" + "UUA" + "\t" + "UUG" + "\t" + "CUU" + "\t" + "CUC" + "\t" + "CUA" + "\t" + "CUG" + "\t" + "UCU" + "\t" + "UCC" + "\t" + "UCA" + "\t" + "UCG" + "\t" + "AGU" + "\t" + "AGC" + "\t" + "UAG" + "\t" + "UAA" + "\t" + "UGA" + "\n")
		vector_file.write(str(header) + "\t")
...
def perform_clustering_analysis(results, genetic_code_ref, number_of_clusters, type_of_analysis, output_dir) :
	...
	if len(results) > 1 :
		...
		PCA_results_by_var.to_csv("./" + output_dir + "/clustering/PCA_results_by_var.tsv", sep='\t', encoding="utf-8")
		...
		variance_explained_PCA.to_csv("./" + output_dir + "/clustering/variance_explained_PCA.tsv", sep='\t', encoding="utf-8")
		...
		if is_numeric == True : 
			...
			clustering_results_for_csv.to_csv("./" + output_dir + "/clustering/clustering_results.tsv", sep='\t', encoding="utf-8")
